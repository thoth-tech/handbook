![Shape1](RackMultipart20220529-1-v9ey3u_html_aac90252c94cb65e.gif)

![](RackMultipart20220529-1-v9ey3u_html_c29aafb8c22d7310.png)
...
[Executive Summary 1](#_Toc104638736)

[Contents 2](#_Toc104638737)

[Leadership Team 3](#_Toc104638738)

[Roles and Responsibilities 4](#_Toc104638739)

[Trimester Goals and Objectives 5](#_Toc104638740)

[Company Charter 6](#_Toc104638741)

[Mission 6](#_Toc104638742)

[Values 6](#_Toc104638743)

[Team Culture 6](#_Toc104638744)

[Roles 6](#_Toc104638745)

[Metrics of success 7](#_Toc104638746)

[Standards of quality 7](#_Toc104638747)

[Company Structure 7](#_Toc104638748)

[Thoth-Tech Senior Leadership 9](#_Toc104638749)

[Thoth Tech Area Lead Project 9](#_Toc104638750)

[Product Overview 16](#_Toc104638751)

[OnTrack 16](#_Toc104638752)

[Front-End Migration Project 18](#_Toc104638753)

[Deployment Project 23](#_Toc104638754)

[Jupyter Notebook Support Project 33](#_Toc104638755)

[Voice Verification Project 38](#_Toc104638756)

[Documentation Project 42](#_Toc104638757)

[SplashKit 46](#_Toc104638758)

[Operations – Migrating Arcana to SplashKit Project 47](#_Toc104638759)

[Operations – Distribution Channels Project 51](#_Toc104638760)

[Extensions Project 56](#_Toc104638761)

[Applications – Arcade Machine Project 62](#_Toc104638762)

[Applications – Build a Cool Game Project 67](#_Toc104638763)

[Modules Project 72](#_Toc104638764)

[DreamBig 79](#_Toc104638765)

[DreamBig Prototype Project 80](#_Toc104638766)

[Internal Systems 84](#_Toc104638767)

[Internal Systems Project 85](#_Toc104638768)

[Government, Risk and Compliance 90](#_Toc104638769)

[Showcase Videos 94](#_Toc104638770)

# Leadership Team

![](RackMultipart20220529-1-v9ey3u_html_a68f98376d8cfffd.png)

## Roles and Responsibilities

| | **Role** | **Responsibilities** | **Skills** | | --- | --- | --- | --- | | **Managing Director**
| The role of the managing director is to oversee the Thoth Tech company executive leadership team
to ensure they are running the company effectively and value is being added to the Thoth Tech
products by the projects they are supporting. |
...
| | **Area Lead** | The role of the Area lead is to drive their area focus across all products and
projects of their area. They also organise, lead, guide, and support Product and Delivery leads
...
| | **Product Lead** | The role of the Product lead is to lead and support delivery leads in
projects related to their product to ensure ongoing success. |
...
| | **Delivery Lead** | The role of the Delivery lead is to lead, organise and support their project
teams to ensure ongoing success. |
...
![Picture 1](RackMultipart20220529-1-v9ey3u_html_4ecf38ab17cf0987.gif)

## Thoth-Tech Senior Leadership

The Thoth-Tech Senior Leadership Team Project&#39;s main objective is to ensure that all project
teams are set up with systems, processes, training, and support to achieve their project
deliverables, and therefore the company objectives and goals. This means that the Thoth Tech company
needs to be established and grown in line with a strong company vision and values, it requires the
guidance of a committed leadership team.

| **Learning Lead:** Liz Lynch **Documentation Lead:** Talia Zidar | **Quality Assurance Lead** :
Katrina Steen **Data and Technical Lead:** Tan Le | | | --- | --- | --- |
...
short-term deliverables by the mid-trimester break.
...
- Create Offboarding process
- Develop talent, establish, and onboard leadership team for T2
- Develop roadmap for T2
- Improve diversity in leadership roles (across Senior Leadership, Product and Delivery leaders)
- Continue to drive the values and culture established in T1 2022
- Iterate and improve the existing processes created in T1 2022
...
- Crafted and documented company mission statement, charter, and values
- Create Company organisation structure
- Allocated teams and projects for OnTrack, SplashKit, DreamBig and Internal Products
- Define leadership roles and responsibilities
- Create branching structure and approval process.
- Create Quality Assurance policy and process.
...
![](RackMultipart20220529-1-v9ey3u_html_e0bad081675e09af.png)
...
- Improve diversity in leadership roles (across Senior Leadership, Product and Delivery leaders)
- Iterate and improve the existing processes created in T1 2022 |
- Provide training and resources to support the Thoth Tech project teams (_ongoing_)
- Add value to Ontrack, DreamBig and SplashKit by supporting project teams to help achieve their
  deliverables (_ongoing_)
- Ensure resources and training are provided to deliver the company goals and objectives (_ongoing_)
  |
- Craft and document company mission statement, charter, and values
- Define leadership roles and responsibilities
- Create Company organisation structure
- Allocated teams and projects for OnTrack, SplashKit, DreamBig and Internal Products
- Establish Thoth Tech Handbook Repo and document all processes created.
- Create Quality Assurance policy and process.
- Create branching structure and approval process.
- Testing, development processes and supportive references
- Create Data Strategy
...
- [Company Charter](https://github.com/thoth-tech/handbook/blob/main/docs/company/charter.md),
  [Roles](https://github.com/thoth-tech/handbook/blob/main/docs/company/roles.md)
- [Company Structure](https://miro.com/app/board/uXjVOHtYWxs=/?share_link_id=972664923450) (Miro)
- [Recruitment](https://miro.com/app/board/uXjVOGWn4k4=/?share_link_id=96134372071) (Miro)
- [Thoth-Tech Handbook](https://github.com/thoth-tech/handbook)
- [Training Documentation](https://github.com/thoth-tech/handbook/blob/main/docs/learning/training/index.md)
- [Quality Assurance Overview](https://github.com/thoth-tech/handbook/blob/main/docs/processes/quality-assurance/quality-assurance-overview.md),
  [Branching Guidelines](https://github.com/thoth-tech/handbook/blob/main/docs/processes/quality-assurance/git-contribution-guide.md#branching-guidelines)
- [Testing and Development](https://github.com/thoth-tech/handbook/blob/main/docs/processes/quality-assurance/testing-and-dev.md)
- [Data and Data Strategy](https://github.com/thoth-tech/handbook/blob/main/docs/data/index.md)
- [Onboarding process](https://github.com/thoth-tech/handbook/blob/main/docs/peopleops/onboarding/onboarding-process.md)
- [T2 Leadership Recommendations](https://github.com/thoth-tech/handbook/blob/main/docs/projects/t1-2022/thoth-tech-leadership/t2-leadership-project-recommendations.md)
- [Offboarding Process](https://github.com/thoth-tech/handbook/blob/main/docs/peopleops/offboarding/offboarding-process.md)
- [Showcase](https://deakin365.sharepoint.com/:v:/r/sites/ThothTech2/Shared%20Documents/General/Company%20OnTrack%20Tasks/Showcase%20Videos/Thoth%20Tech%20Showcase%20Video.mp4?csf=1&web=1&e=7ma00Z)
...
###### Short-term Deliverables:\_ \_

Area Leads have successfully completed all short-term deliverables, and since the last company
report have achieved the following:
...
- Allocated team members to projects based on requested products and skills​ | Liz Lynch, Talia
  Zidar, Katrina Steen, Tan Le | | Thoth Tech Handbook Repo established, and processes and artifacts
  documented. | Tan Le (established), contributed to by Liz Lynch, Talia Zidar, Katrina Steen | |
  Quality Assurance policy and process:​
- Created branching structure and approval process. ​
- Created testing, development processes and supportive references​ | Katrina Steen | | Data
  Strategy:
- Created Data Strategy and Metrics Template​
- Created Testing Strategy Template​ | Tan Le | | Communication guidelines:
- Established communication guideline for Thoth Tech
- Created Professional Communication Guide
- Created Company Writing Style Guide | Talia Zidar | | Training and mentoring sessions:
- GitHub Workshop (Tan)
- QA Workshop (Katrina)
- Documentation Workshop​ (Talia)
- D/HD Student Workshop​ (Liz)
- Leadership Conference (Liz)
- Leadership Retrospective demo (Katrina) | Liz Lynch, Talia Zidar, Katrina Steen, Tan Le (led as
  specified) | | ​Training guide creation and feedback collection
...
- Mentoring Guide (Liz) | Liz Lynch, Talia Zidar, Katrina Steen, Tan Le (as specified) | | Capstone
  Cohort Guest Presentations and sessions arranged:
- Kirsty McDonald: _Women in Tech_ (Liz)
- Daniel Yong: _Industry Insight_ (Talia &amp; Katrina)
- Leadership Conference (Liz) | Liz Lynch, Talia Zidar, Katrina Steen (as specified) | | Handover
  and Offboarding completed:
- Showcase
- T2 Roadmap Planning
- Offboarding Process (Katrina), surveys (Liz)
- Handover Process
- T2 leadership development | Liz Lynch, Talia Zidar, Katrina Steen, Tan Le |
...
![](RackMultipart20220529-1-v9ey3u_html_ae45a852f3456990.png)
...
features. Once migrations are completed, it&#39;s possible to add more advanced and quicker features
to OnTrack.
...
&amp; Angular. The team is ramping up production output on a week-by-week basis as the team is
becoming increasingly confident with the skills required for migrations. Which such figures and
increased performance, the team can state with confidence that expected deliverables will be
exceeded.
...
| | **In Progress** | **Completed** | **PR** | | --- | --- | --- | --- | | **Group 1** |
...
./src/app/visualisations/task-completion-box-plot.coffee | | | | **Group 3** |
...
[PR #11](https://github.com/thoth-tech/doubtfire-web/pull/11) | | **Group 4** |
./src/app/tasks/modals/grade-task-modal/grade-task-modal.coffee | |
[PR #1](https://github.com/thoth-tech/doubtfire-web/pull/1) | |
./src/app/tasks/modals/plagiarism-report-modal/plagiarism-report-modal.coffee | |
[PR #5](https://github.com/thoth-tech/doubtfire-web/pull/5) | |
./src/app/common/grade-icon/grade-icon.coffee | |
[PR #8](https://github.com/thoth-tech/doubtfire-web/pull/8) | | **Group 5** |
./src/app/tasks/task-status-selector/task-status-selector.coffee | |
[PR #12](https://github.com/thoth-tech/doubtfire-web/pull/12) | |
...
| | [PR #12](https://github.com/thoth-tech/doubtfire-web/pull/12) | | **Group 6** |
./src/app/tasks/task-submission-viewer/task-submission-viewer.coffee | |
[PR #4](https://github.com/thoth-tech/doubtfire-web/pull/4) | | ./src/app/tasks/tasks.coffee | |
[PR #4](https://github.com/thoth-tech/doubtfire-web/pull/4) | | ./src/app/tasks/modals/modals.coffee
| | [PR #4](https://github.com/thoth-tech/doubtfire-web/pull/4) | |
./src/app/tasks/modals/upload-submission-modal/upload-submission-modal.coffee | |
[PR #13](https://github.com/thoth-tech/doubtfire-web/pull/13) | | **Group 7** |
...
[PR #2](https://github.com/thoth-tech/doubtfire-web/pull/2) | | |
...
[PR #2](https://github.com/thoth-tech/doubtfire-web/pull/2) | | **Group 8** |
...
| | **Progress** | **Completed** | **PR** | | --- | --- | --- | --- | | **Group 1** | |
migrate/admin-notification | [PR #22](https://github.com/thoth-tech/doubtfire-web/pull/22) | |
**Group 2** | ./src/app/visualisations/progress-burndown-chart.coffee | |
[PR #36](https://github.com/thoth-tech/doubtfire-web/pull/36) | |
...
[PR #42](https://github.com/thoth-tech/doubtfire-web/pull/42) | | |
./src/app/common/modals/confirmation-modal/confirmation-modal.coffee |
[PR #41](https://github.com/thoth-tech/doubtfire-web/pull/41) | | |
./src/app/common/modals/progress-modal/progress-modal.coffee |
[PR #40](https://github.com/thoth-tech/doubtfire-web/pull/40) | | **Group 3** | |
./src/app/tasks/project-tasks-list/project-tasks-list.coffee |
[PR #34](https://github.com/thoth-tech/doubtfire-web/pull/34) | | |
./src/app/admin/modals/user-settings-modal/user-settings-modal.coffee |
[PR #11](https://github.com/thoth-tech/doubtfire-web/pull/11) | | **Group 4** |
plagiarism-report-modal.coffee | | | | | grade-icon |
[PR #18](https://github.com/thoth-tech/doubtfire-web/pull/18) | | | grade-task-modal |
[PR #1](https://github.com/thoth-tech/doubtfire-web/pull/1) | | | fix: scroll into view error |
[PR #37](https://github.com/thoth-tech/doubtfire-web/pull/37) | | | refactor: remove
task-sheet-viewer component | [PR #9](https://github.com/thoth-tech/doubtfire-web/pull/9) | | |
docs: update contributing.md doc | [PR #2](https://github.com/thoth-tech/doubtfire-deploy/pull/2) |
| | fix: update urls in .gitmodules | [PR #1](https://github.com/thoth-tech/doubtfire-deploy/pull/1)
| | **Group 5** | |
./src/app/projects/states/dashboard/directives/task-dashboard/directives/task-outcomes-card/task-outcomes-card.coffee
| [PR #12](https://github.com/thoth-tech/doubtfire-web/pull/12) | | |
./src/app/projects/states/dashboard/directives/task-dashboard/directives/task-status-card/task-status-card.coffee
| [PR #29](https://github.com/thoth-tech/doubtfire-web/pull/29) | | **Group 6** | |
./src/app/groups/group-member-contribution-assigner |
[PR #38](https://github.com/thoth-tech/doubtfire-web/pull/38) | |
./src/app/tasks/modals/upload-submission-modal-coffee | |
[PR #13](https://github.com/thoth-tech/doubtfire-web/pull/13) | | |
./src/app/common/file-uploader/file-uploader.coffee |
[PR #30](https://github.com/thoth-tech/doubtfire-web/pull/30) | |
./src/app/tasks/task-submission-viewer/task- submission-viewer.coffee. | |
[PR #4](https://github.com/thoth-tech/doubtfire-web/pull/4) | | ./src/app/tasks/tasks.coffee | |
[PR #4](https://github.com/thoth-tech/doubtfire-web/pull/4) | | **Group 7** |
./src/app/admin/modals/create-unit-modal/create-unit-modal.coffee

| | [PR #24](https://github.com/thoth-tech/doubtfire-web/pull/24) | | |
...
./src/app/errors/states/timeout/timeout.coffee | PR #2 | | | app/states/teaching-period-breaks |
[PR #544](https://github.com/doubtfire-lms/doubtfire-web/pull/544) | | **Group 8** | |
./src/app/projects/states/portfolio/directives/portfolio-welcome-step/portfolio-welcome-step.coffee
| [PR #33](https://github.com/thoth-tech/doubtfire-web/pull/33) |
...
[_https://trello.com/b/pFPgCaIo/front-end-migration_](https://trello.com/b/pFPgCaIo/front-end-migration)
...
| **Google Cloud\*\*** Cloud/DevOps Engineer: **Joyce Cruz** Back-end Developer:**Sultan Hindi A
Albishri | **Pipeline\***\* DevOps Engineer:**Mathew PerkinsLachlan Cayzer | **Enhance
Authentication\*\*** Full-stack Developer: **Linden Hutchinson** Back-end Developer:\*\*Nathan
SukamtoSarah Nicole DysonXueTing Jing | | --- | --- | --- |
...
- Upskill tasks (Google Cloud and services, deployments, Docker containers)
- Project plan
...
- investigate notifying the docker containers of a new version. (e.g., Webhooks, daily cron jobs.),
...
- Research into GCP cloud build and cloud run as pipeline tool
...
The Enhance Authentication deliverable is progressing as expected and the short-term deliverables
are expected to be finished by the end of trimester.
...
- Migrate relevant Coffeescript component to Typescript (consulting with front-end migration team) |
- Upskilling Docker
...
- Integrate with CI/CD pipelines to automate deployment into GCP
...
- Write Docker Script to prepare docker container for doubtfire
- High Level Diagram - GCP &amp; CICD
- Request GCP Access
- Configure Proxy for doubtfire-API and Doubtfire-web containers
- Generate certificate and key for https access to the application, and network setup to route
  public traffic to the host |
- [Miro board](https://miro.com/app/board/uXjVO0h8ZSE=/?share_link_id=62396987373)
- [PR #5 Commits](https://github.com/thoth-tech/doubtfire-deploy-GCP/pull/5/commits)
- Access location: [https://34.129.127.168](https://34.129.127.168/)
- Trello board card:
  [https://trello.com/c/yBlba3PQ/65-write-docker-script-to-prepare-docker-container-for-ontrack-doubtfire](https://trello.com/c/yBlba3PQ/65-write-docker-script-to-prepare-docker-container-for-ontrack-doubtfire)
- [Google Cloud Documentation](https://github.com/thoth-tech/documentation/blob/main/docs/OnTrack/Deployment/Google%20Cloud/Index.md)
- [Google Cloud Miro Board - Doubtfire](https://miro.com/app/board/uXjVO0h8ZSE=/?share_link_id=62396987373)
- [Google Cloud Miro Board – CI/CD](https://miro.com/app/board/uXjVO64xoQw=/?share_link_id=57734801709)
...
| Joyce Cruz andSultan Hindi A Albishri | | Updated docker-compose.yml | Sultan Hindi A Albishri | |
...
| Joyce Cruz andSultan Hindi A Albishri |
...
- Validate Deployment Pipeline
- Bring together completed OnTrack build pipeline implementing everything into a final deployment
  ready product
- Build diagram of build pipeline
- Create automated deployment of Ontrack using Jenkins pipeline
- Implement tests with build pipeline
- Look into notifying the docker containers of an updated version e.g., Webhooks, daily cron jobs
  etc |
- Test Mock Deployment
- Learn CI/CD pipeline tool
...
- Investigate Argo CD as deployment platform (look into OnTrack on Kubernetes hosting)
- Deploy Jenkins on GKE
- Assess the best CI/CD to use with GCP
- Look into GCP cloud build and cloud run as pipeline tool |
  [http://34.129.4.185:50000/login?from=%2F](http://34.129.4.185:50000/login?from=%2F) |
...
| Mathew Perkin andLachlan Cayzer | | Successfully built Google Kubernetes Engine cluster on the
Google Cloud Platform

- Used to host Jenkins
- Collaborated with Pipeline Build team

| Mathew Perkin andLachlan Cayzer | | Domain name

- Begin process to obtain user-friendly domain name

| Mathew Perkin andLachlan Cayzer |
...
- Analysis of current &amp; proposed authentication systems 5.1 |
- [Research LDAP/Devise 3.0](https://github.com/thoth-tech/documentation/blob/main/docs/OnTrack/Deployment/Enhanced%20Authentication/Research%20%26%20Findings/LDAP-and-devise-research-documentation.md)
- [testing strategy document](https://github.com/thoth-tech/documentation/blob/main/docs/OnTrack/Deployment/Enhanced%20Authentication/testing-strategy-enhance-authentication.md)
  |
...
| Nathan Sukamto and Linden Hutchinson\*Nathan Sukamto | | Documentation

- Developing the team testing strategy
- Report comparing the current and proposed authentication systems for OnTrack
- Research on the topics of Devise and LDAP servers. | Sarah Nicole Dyson | | In progress: LDAP
  docker
- Build and test
...
&#39;.ipynb&#39; files directly to OnTrack. As a result of this limitation, student users must
export their Jupyter Notebook file as an HTML document, and then use a PDF converter to create a PDF
suitable for uploading to OnTrack. This results in an inefficient, poor, and frustrating user
experience.

The goal of this project is to solve this issue by allowing students to upload .ipynb files directly
to OnTrack and utilise OnTrack&#39;s PDF conversion pipeline to handle automatically converting the
file to PDF format for the faculty staff to view.
...
&#39;.ipynb&#39; files into OnTrack, as well as documentation on the feature and a user guide on how
...
- Create prototype that will convert a Jupyter Notebook and a Word document into a pdf. This will be
  done with two buttons that will trigger their respective functionalities, which will be
  implemented through back-end command line commands.
- Investigate further conversions from the existing libraries

|

- Code for converting a Jupyter Notebook file (.ipynb) into PDF format
- Code for converting a word document (.docx) into PDF format. This is being done by creating a Java
  CLI application to convert .docx to .pdf with Apache POI
- Project Documentation
- Create Docker container that can run nbconvert to pdf at command line
- Docker Compose for a multi-container
- Investigate front end repository to identify where changes will need to be made
...
- User stories
- Investigate doubtfire-api repository for where code will need to be modified
- Install Prerequisite Software
- Clone doubtfire repository
- Expansion of the excel workbook to include personalised stats for all team members about all
  activities they have completed and the amount of time for each. |
...
|
[Software Requirement Specification document link](<https://github.com/thoth-tech/documentation/blob/main/docs/OnTrack/Jupyter%20Notebook/Prototype%20SRS%20(Software%20Requirements%20Specification).md>)
[All meeting minute documents link](https://github.com/thoth-tech/documentation/tree/main/docs/OnTrack/Jupyter%20Notebook/Meeting%20Minutes)
[Jupyter Notebook Documentation Index link](https://github.com/thoth-tech/documentation/blob/main/docs/OnTrack/Jupyter%20Notebook/Index.md)
[https://github.com/thoth-tech/jupyter-notebook-prototype](https://github.com/thoth-tech/jupyter-notebook-prototype)
[Jupyter notebook to PDF](https://github.com/thoth-tech/jupyter-notebook-prototype)
[.docx to PDF code link](https://github.com/thoth-tech/jupyter-notebook-prototype/tree/main/docxtopdf)
[https://github.com/thoth-tech/jupyter-notebook-prototype/blob/main/README.md](https://github.com/thoth-tech/jupyter-notebook-prototype/blob/main/README.md)
[Flowchart link](https://github.com/thoth-tech/documentation/blob/main/docs/OnTrack/Jupyter%20Notebook/docker_flow.png)
[Docker Documentation and Research document link](https://github.com/thoth-tech/documentation/blob/main/docs/OnTrack/Jupyter%20Notebook/Docker-Documentation-Research-T1-2022.md)
|
...
| **A\*\*** chievements \*\*                                         | ** C \*\***ontributor\*\*       |
| ------------------------------------------------------------------ | ------------------------------- |
| Jupyter notebook to PDF conversionMicrosoft word to PDF conversion | Lachlan Foy, Jordan John Litsas |
| Docker environment implementation                                  | Chetan Nagar                    |
| SRS documentProject documentation                                  | Matt Clark and Ethan Keirs      |
| Excel Spreadsheet functions                                        | Ethan Keirs                     |
| Technical Mentoring                                                | Lachlan Foy                     |
...
- Documentation (User documentation, Deployment Documentation, and Architecture Documentation). |
- SRS Document |
  ...
  [Voice Verification Trello Card](https://trello.com/c/dgHkV3Yb)
  [User Document | Trello](https://trello.com/c/mu9Pcl1W)
  [Deployment Documentation | Trello](https://trello.com/c/6b7UHajP)
  [Architecture Document | Trello](https://github.com/thoth-tech/documentation/pull/70) |
...
products, including OnTrack. The current state of documentation of Thoth Tech&#39;s products&#39; is
poor; with previous design decisions, updates and feature implementations not accurately documented
or maintained. By clearly documenting the products Thoth Tech&#39;s employees will be set up for
success to hit the ground running when joining the company and a team. Additionally, the
products&#39; end users, which include university students and educators, will find it easy to learn
and use the products with simple and accessible documentation at hand.
...
gaps, collaborating with development teams&#39;, and creating new documentation, the contributions
made by the documentation team will set up future team leaders and members who decide to join Thoth
Tech for success.
...
confidence improves. The scope has expanded from OnTrack alone, to all of Thoth Tech&#39;s
product&#39;s documentation. Work currently underway includes:
...
| Future work will focus on producing a report of recommendations and expectations for current
project teams to implement for documentation of their projects. Along with this, the project team
will produce templates for:

- design documentation
- user documentation
- user guides, and
- requirement documentation. The report and associated templates will consolidate the team&#39;s
  work this trimester and provide a solid foundation for all team to produce documentation in the
  future. | All Thoth Tech repositories are currently being analysed for existing documentation. The
  various repositories have been distributed as Trello cards amongst the team. Together, the team is
  producing an analysis document with comments on each document. There is checklist of attributes to
  be checked and commented on for each document which includes:
- filename
- completeness
- accuracy
- currency
- format
- description, and
- type. | A documentation repository has been created, and communications have been distributed to
  the project teams on its use. This provides a single point of reference for teams to store and
  manage documents related to their projects. Current and future Thoth Tech employees will find this
  resource useful when seeking to understand decisions, plans and designs. |
...
- Produce report of recommendations for project teams to implement for documentation of their
  projects |
- Analyse documentation in existing repositories |
- Create documentation repository |
  [thoth-tech/documentation repository](https://github.com/thoth-tech/documentation)
  [Analysis - Each Repo.docx](https://deakin365.sharepoint.com/:w:/s/OnTrackDocumentation/EWUe6wCeexBPsX62suL1BrQBd3YfKvnnpDVgS_9y2G9Z4w?e=af7te3)
  [Produce analysis report with solutions on Documentation Trello Card](https://trello.com/c/6HqFGuUp/30-produce-analysis-report-with-solutions)
  [Produce report of recommendations for project teams to implement for documentation of their projects on Documentation Trello Card](https://trello.com/c/RUQRcnO4/31-produce-report-of-recommendations-for-project-teams-to-implement-for-documentation-of-their-projects)
  |
...
![](RackMultipart20220529-1-v9ey3u_html_a04c96f9c1d0e6b6.png)
...
programming concepts to those new to programming. From the programming Arcana&#39;s GitHub, the
...
- Complete the translation of SwinGame code to SplashKit.
  ([PR #1](https://github.com/thoth-tech/programming-arcana/pull/1))
...
- Code format config file created, GitHub action CI created, document updated.

|
[programming-arcana/tree/master/topics](https://github.com/splashkit/programming-arcana/tree/master/topics)
[PR1](https://github.com/thoth-tech/programming-arcana/pull/1),
[PR2](https://github.com/thoth-tech/programming-arcana/pull/4),
[PR3](https://github.com/thoth-tech/programming-arcana/pull/5),
[PR4](https://github.com/thoth-tech/programming-arcana/pull/6)
[PR1](https://github.com/thoth-tech/programming-arcana/pull/2) |
...
At this time the project is classified as complete, so long-term deliverables are unknown.

##### Key Team Achievements

| **Achievement**                         | **Contributor**                                                                   |
| --------------------------------------- | --------------------------------------------------------------------------------- |
| Merge code to the head branch           | Ray Guo, Lachlan Morgan, Devesh Juggiah, Ray GuoRichard Douglas-Denton (reviewer) |
| Implement code formatter to the project | Ray GuoTan Le and Talia Zidar                                                     |
...
challenge would be the native &#39;clang-format&#39; package is not easy to use so we had to find a
wrapper script to addon additional features like coloured difference.
...
[2][https://github.com/thoth-tech/programming-arcana/pull/1](https://github.com/thoth-tech/programming-arcana/pull/1)
...
- Research the existing installation process, the SplashKit management tool &quot;skm&quot;, and
  possible methods of improved installation on all three major operating systems.
...
| **MacOS Specialist:** Richard Douglas-Denton | **Software** **Developer:** Lachlan MorganTrent
Mizzi | | | --- | --- | --- |
...
_install a Unix-like development environment_ _ **AND** _ _SplashKit_. One solution is to use the
software package manager Chocolatey to install the Msys2 virtual Unix environment, then execute a
SplashKit installation script. Chocolatey can be installed using a PowerShell script which then can
call other scripts after installation has been completed. Alternatively, the team is considering
writing a single PowerShell script that installs Msys2 before then executing a SplashKit installer
directly inside Msys2 (all in one-command). This solution could be distributed in a zip file of
scripts with readme documentation. However, this would not achieve the goal of a single-click
executable.
...
- The team is still researching whether to use a package manager such as Chocolatey or attempt to
  write a single PowerShell script to deploy skm.

|

- The Linux installation script is under development and expected to closely follow that of the
  macOS script
...
- Completion of macOS one-command installation script, reviewed and merged [2]
- Completion of planning for Linux one-command installation script
- Completion of SplashKit-core CMake modifications to enable M1 Mac compilation support via x86_64
  Rosetta translation [3] (pending final review and merge)
...
[2] [https://github.com/thoth-tech/skm/pull/3](https://github.com/thoth-tech/skm/pull/3)

[3]
[https://github.com/thoth-tech/splashkit-core/pull/1](https://github.com/thoth-tech/splashkit-core/pull/1)
...
- Make Windows install simple one-step executable to install
- Branch and merge native replicable ARM build for SplashKit-core for M1
- Merge all three OS specific installation scripts into `skm-install.sh`
...
- Branch and create native replicable ARM builds for SplashKit-core for M1 using arm64 linked
  external libraries
- Port macOS bash one-command installation script to support Linux
- Make Linux install simple one-step executable
- Temporary fix for forcing x86_64 on M1 for SplashKit-core
- Create a new `skm-install-mac.sh` bash script that automates the installation process
- Work out existing installation for windows
- Make MAC install simple one-step executable to install |
  [thoth-tech/skm: CLI and GUI app for SplashKit](https://github.com/thoth-tech/skm)
- [PR#3](https://github.com/thoth-tech/skm/pull/3)
- [PR#4](https://github.com/thoth-tech/skm/pull/4)
- [PR#4](https://github.com/thoth-tech/skm/pull/5)

[thoth-tech/splashkit-core: Core code for SplashKit—beginner&#39;s all-purpose SDK](https://github.com/thoth-tech/splashkit-core)

- [PR#1](https://github.com/thoth-tech/splashkit-core/pull/1) |
...
| **Achievement**                                       | **Contributor**                                      |
| ----------------------------------------------------- | ---------------------------------------------------- |
| Initial research documentation\_ \_                   | Richard Douglas-DentonTalia Zidar (reviewer)         |
| Complete macOS one-command installation solution\_ \_ | Richard Douglas-Denton\_ \_Tan Le and Lachlan Morgan |
| (reviewer)                                            |
| Complete Linux one-command installation solution\_ \_ | Richard Douglas-Denton\_ \_Tan Le and Lachlan Morgan |
| (reviewer)                                            |

| Complete Apple Silicon compatibility fix for SplashKit-core

- allowing newer Apple M1 devices to compile SplashKit core\_ _ | Richard Douglas-Denton_ _Tan Le
  and Lachlan Morgan (reviewer) | | Development of testing strategy documentation_ \_ | Richard
  Douglas-DentonTalia Zidar (reviewer) |
...
Python (\&lt; 3.8), Pascal, Rust, and C#. The SplashKit Extensions project&#39;s aim is to provide
the SplashKit library interface in additional languages.
...
| **Software Engineer:** Ben ThomasJack SieversSicheng Liu | **Software Develop\*\*** er:\*\*Norbert
PopDylan MedlinJingze DuTimothy Wilbert | | | --- | --- | --- |
...
instructions and solutions are well documented and to prevent impediments for future developers.
Written instructions on how to setup the SplashKit translator on both systems, as well as
development instructions have been produced and currently awaiting review in pull requests.
...
- Document running SplashKit translator in Windows using WSL
...
##### Indicate any changes to plans for the project \_ \_
...
- Test SplashKit Python translator with versions prior to 3.8
- Test SplashKit translator with version 3.10
- Create documentation for Python changelog from 3.7 to 3.8 for tracking potential causes for
  incompatibility |
- Investigate getting SplashKit translator working on Ubuntu 20.04
- Investigate getting SplashKit translator to work on macOS with Docker
- Document Splashkit-translator development setup and operation.
- Create docker-compose file.
- Submitted Software Change Request form for review by Thoth Tech leadership |
  [Docker_README.md](https://github.com/thoth-tech/splashkit-translator/blob/master/Docker_README.md)
  [Splashkit Translator PR#3](https://github.com/thoth-tech/splashkit-translator/pull/3)
  [commit: docker compose](https://github.com/thoth-tech/splashkit-translator/commit/a29c6cd50f2fab33177af489732336307e604efd)
  [Splashkit-translator: feat/rust](https://github.com/thoth-tech/splashkit-translator/commits/feat/rust)
  [Extensions SRS](https://github.com/thoth-tech/documentation/blob/main/docs/Splashkit/Extensions/Language%20Extensions/Research%20%26%20Findings/Software%20Change%20Request.md)
  [csharp_documentation](https://github.com/thoth-tech/splashkit-translator/tree/csharp_documentation)
  [Extensions/Python Compatibility Research](https://github.com/thoth-tech/documentation/blob/main/docs/Splashkit/Extensions/Python%20Compatibality/Research%20%26%20Findings/Python%20Changelog.md)
  |

##### Aims for Trimester Status\_ \_
...
| **Task **                                                           | **Information **                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Test SplashKit Python translator with Python versions prior to v3.8 | The team need to successfully use the translated Python file and import it into a Python project. Currently the Python project throws an error when trying to run that it cannot find the SplashKit library. [https://trello.com/c/ukKKR2mt/12-test-splashkit-python-translator-with-python-versions-prior-to-v38](https://trello.com/c/ukKKR2mt/12-test-splashkit-python-translator-with-python-versions-prior-to-v38)                                                                |
| Test SplashKit Python translator with Python 3.10                   | The team need first get SplashKit working for Python v3.8 as this is supposed to be working to help understand what has changed and is now preventing the translator from working with v3.10. [https://trello.com/c/2TKSoxGt/13-test-splashkit-python-translator-with-python-310](https://trello.com/c/2TKSoxGt/13-test-splashkit-python-translator-with-python-310)                                                                                                                   |
| Complete Rust Language Extension                                    | The Rust Language is a modern general programming language that is being utilised in many modern settings, including Linux development. The Rust translator currently outputs a Rust file that when compile gives numerous errors. The Rust.rb file needs to be updated to ensure that the correct syntax is being written for the output file. [https://trello.com/c/2d8COBUg/27-complete-rust-language-extension](https://trello.com/c/2d8COBUg/27-complete-rust-language-extension) |

**Backlog Tasks **

| **Task **                                                               | **Trello link **                                                                                                                                                                                                                                                                                                                                                                                              |
| ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Fix symlinks for Windows                                                | The symlink files used by the SplashKit translator do not work correctly in Windows after pulling from GitHub. This issue needs to be investigated and fixed. [https://trello.com/c/lNnTviht/32-fix-symlinks-for-windows](https://trello.com/c/lNnTviht/32-fix-symlinks-for-windows)                                                                                                                          |
| Provide progress/status updates to terminal when running the translator | The translator appears idle for some time when operating and can take a significant amount of time. A progress indicator would help users understand that the application is still processing. [https://trello.com/c/blr2SGHh/31-provided-progress-status-updates-to-terminal-when-running-translator](https://trello.com/c/blr2SGHh/31-provided-progress-status-updates-to-terminal-when-running-translator) |
| Create Ruby language extension                                          | Ruby is a functional programming language that the team need to learn as the translator project is written in Ruby. This makes is a great candidate for translating SplashKit into. [https://trello.com/c/Xw8pfXD2/29-create-ruby-language-extension](https://trello.com/c/Xw8pfXD2/29-create-ruby-language-extension)                                                                                        |
| Create Go language extension                                            | The Go programming language is a feature rich, easily readable language and is very rarely updated or changed. [https://trello.com/c/tYqxZ40k/28-create-go-language-extension](https://trello.com/c/tYqxZ40k/28-create-go-language-extension)                                                                                                                                                                 |
...
- MacOS
- Windows
- Linux | Dylan Medlin, Ben Thomas, Allan Farrell, Tan Le, Jack Sievers | | Docker Compose
  configuration simplifies developing and using the translator | Tan Le, Dylan Medlin, Allan Farrell
  | | Documentation of setup and usage of the translator will make it easier for future teams to
  work on this project | Jack Sievers, Allan Farrell, Ben Thomas, Timothy Wilbert, Dylan Medlin |
...
- Implement dynamic loading screen to visualise GitHub resources being pulled
- User testing
- User acceptance
- Request for student games to be included
- &quot;Created by&quot; intro animation |
- Creating the arcade machine class which is the parent class to all other parts of the software.
- Creating a new linked list data structure for games menu
- Animation carousel for game selection
- Refining options menu class |
- An introductory Splash Screen and loading screen, accompanied with graphics and sound
- Configuration data text file template and interpreter
- Grid class for development of structured user-interfaces using a grid style layout.
- Options menu allowing the user to select audio level and change music tracks
- Main menu screen
...
- Requirements and Design documents. &quot;What&quot; we are building and &quot;How&quot; it will be
  built
- GUI Design document
...
- Linking cells |
- [Documentation Applications](https://github.com/thoth-tech/documentation/tree/main/docs/Splashkit/%20Applications%20)
...
Creation of foundational grid/menu/button asset drawing and function classes | Riley Nicholas
Dellios, Sarah Gosling, Anthony | | Creation of selector and action functional classes | Sarah
Gosling | | Creation of configuration data file and parser | Anthony George | | Creation of
repositories to store games and code | Anthony, Sarah Gosling | | Creation of user guide
documentation | Anthony, Sarah Gosling, Riley | | Contribution of assets and design | Anthony, Sarah
Gosling, Riley Nicholas Dellios, Nguyen Quoc Huy Pham | | Working Windows based software application
| Anthony, Sarah Gosling, Riley Nicholas Dellios, Nguyen Quoc Huy Pham |
...
The Cool Games team has progressed with each team member&#39;s respective deliverable being
developed and documented. Although delayed in the first weeks, each respective member has been
working and completing parts of their project at great speed.
...
- Sounds Importing
- User Article Series |
- Progressing on level editor: bug fixing and issue resolutions.
- A.I Fixes
...
- For the game **Tanks** , the A.I for the tanks has been created and the assets are being worked
  on. The current state of the game is sitting around 40% complete. The game class has been created
  also meaning that there is a working demo.
...
- The Game **Dicey Combat:** will be able to move both players across the board with the right
  direction movement. As well as having the score board synchronized with the players&#39; winning
  or losing points.
...
- Create demonstration of Jump Game design e.g., PowerPoint
- Create prototype presentation of the game
- Testing for the game |
  [Applications Documentation](https://github.com/thoth-tech/documentation/tree/main/docs/Splashkit/Applications)[_Jump Game Repo_](https://github.com/thoth-tech/Jump)
  [_Tanks Game Repo_](https://github.com/thoth-tech/Tanks) |
...
[_https://github.com/thoth-tech/documentation/tree/main/docs/Splashkit/Applications_](https://github.com/thoth-tech/documentation/tree/main/docs/Splashkit/Applications)

[_https://trello.com/c/fDkzRSgx/16-dicey-combat-designing-the-draft-image-assets_](https://trello.com/c/fDkzRSgx/16-dicey-combat-designing-the-draft-image-assets)

[_https://trello.com/c/YR4ed8lx/20-game-creation-jump-handle-player-input_](https://trello.com/c/YR4ed8lx/20-game-creation-jump-handle-player-input)

[_https://trello.com/c/7RzExBga/17-dicey-combat-players-collisions_](https://trello.com/c/7RzExBga/17-dicey-combat-players-collisions)

### Modules Project

#### _Overview, Goals, and Objectives _
...
| **Machine Learning\*\*** Machine Learning Developer: \*\*Harry Dentry | ** Physics \*\*** Software Developer: \*\*Daniel Robert HayshamKanna Srilakshmanan | ** Data Analytics \*\***Software Developer:\*\* Ryan Allan LawrenceTimothy MooreKai Tao |
| --------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
...
- Designing and establishing a testing strategy for T3 code
...
- Frameworks have been implemented for users to submit actions to an AI
- Random agents and Q-Tables have been created for initial AI testing
...
- Code documentation |
  [feature/ml_game_ai](https://github.com/thoth-tech/splashkit-core/tree/feature/ml_game_ai)[PR#59](https://github.com/thoth-tech/documentation/pull/59)
  |

##### _Aims for Trimester Status_
...
(how the system &quot;sees&quot; the game) has been made dynamic and users can now make inputs for
many more elements such as player health and current player.
...
- T3 code review
- Code compilation |
  [Documentation of Data Analytics](https://github.com/timmydzeko/documentation/tree/main/docs/Splashkit/Modules/Data%20Analytics)
  |
...
| Documentation                                         | Ryan Allan Lawrence andTimothy Moore            |
| Trello, Git and GitHub usage guides                   | Ryan Allan Lawrence andTimothy Moore            |

##### Project Recommendations

The redesign of the Data Frames can be inspired by Python&#39;s implementation of Pandas. Creating a
UML diagram and documentation would prevent the same issues faced by the team in trimester one.
...
- Code compilation
- T3 API design |
  [Comparison of Daniel&#39;s work](https://github.com/thoth-tech/splashkit-core/compare/develop...someguy8:develop)
  |
...
_Trello board link:_
[_https://trello.com/b/SKqf30oS/modules_](https://trello.com/b/SKqf30oS/modules)
...
![](RackMultipart20220529-1-v9ey3u_html_cbc735b5dada7017.png)
...
| **Back-end Integration Developer:** Zac Brydon **Database Engineer:** Munatsi Matipana |
**Documentation &amp; Security Specialist:** Harrison Paul AllwoodGeorge Gkoumas | **Front-end
Design:** Guanyu ChenHarry Lui | | --- | --- | --- |
...
- Reworked user stories and features with the team according to the functionality requirement given
  by the board.
- The team has performed individual research in their selected areas for the prototype (e.g.,
  front-end, security, etc.). |
...
[DreamBig Trello Board](https://trello.com/b/5hGRqxJO/dreambig-prototype) - _Wireframe sets will be
linked in the Trello board card._
...
incorporate everyone&#39;s availability. Another important takeaway we had was managing deadlines,
as a team starting the project from scratch, we had many tasks that went over the expected date or
had to extend due to changing tutor requirements.
...
- User stories
- Features list
- Wireframes for login, first home page, edit profile and add activities page.
- Individual research |
  [Figma](https://www.figma.com/file/ccUGpRo28eDydJeHGmf6aA/prototype?node-id=161%3A88)[Documentations PR](https://github.com/thoth-tech/documentation/pull/58)[Trello](https://trello.com/b/5hGRqxJO/dreambig-prototype)[PR#64](https://github.com/thoth-tech/documentation/pull/64)
  |
...
- Converting documents from Teams to GitHub | Zac Brydon, Munatsi Matipana, and George Gkoumas. | |
...
- Trello board management | Neha Makineni |
...
Git documentation:
[https://github.com/thoth-tech/documentation/tree/main/docs/DreamBig](https://github.com/thoth-tech/documentation/tree/main/docs/DreamBig)

ERD:
[https://lucid.app/lucidchart/515a1c6d-0ce2-47b6-88f7-fd04ec3957b1/edit?page=0_0&amp;invitationId=inv_b3dfcee3-3b63-43e6-9fca-40d150f868f0](https://lucid.app/lucidchart/515a1c6d-0ce2-47b6-88f7-fd04ec3957b1/edit?page=0_0&invitationId=inv_b3dfcee3-3b63-43e6-9fca-40d150f868f0)
...
![](RackMultipart20220529-1-v9ey3u_html_8ba8393e153e3d34.png)
...
company&#39;s information needed for its internal audience. This in turn will simplify the
onboarding and resource sharing amongst the company and its everchanging audiences.
...
- Create User Stories |
  ...
  [Documentation Repository](https://github.com/thoth-tech/documentation/tree/main/docs/Internal%20Systems)
  |
...
- **System Architecture Design** - System architecture design is the blueprint or base of the
  website design by which the static site can be upgraded. This will give developers the idea of
  what needs to be done and it will help them to complete the project easily.
...
| Google Cloud Hosting – Choosing the right platform for hosting a website can also be confusing.
GCP research included the cons and pros of Google cloud hosting. And comparison with GitHub to get
the idea on which would be best for our project. | Tushar | | Back-end Technologies – The initial
research regarding whether the website should be static or dynamic, some research was done on some
back-end technologies just in case if the website must be dynamic. | Tushar | | Gatsby starter
codebase for the repo – Created Gatsby starter project, installed markdown plugins to be used later
and moved all the code to internal system repository | Areeb Ijaz | | Front-end Technologies – Did
some research on some set front-end technologies for the development of user interface of website. |
Manveen Kaur Bhullar | | Spike Testing Gatsby – Created a simple documentation site including docs
plugin to test Gatsby. Like Jekyll testing, created documentation to include why we should be using
Gatsby instead of other technologies | Areeb Ijaz | | Gatsby starter guide – Created a guide for
future students to understand Gatsby and get up to speed with it. | Areeb Ijaz | | UI/UX
Documentation – Created to act as a point of reference, providing context for the product&#39;s
progress from concept to current version. | Matthew Fletcher | | General webpage management |
Matthew Fletcher | | Webpage development/integration, both front-end and back-end | Areeb Ijaz | |
Hosting services | Areeb Ijaz | | Website design prototype – created a document highlighting few
designs and structure of static website | Manveen Kaur Bhullar | | GitHub Hosting and GitHub Actions
| Manveen Kaur Bhullar | | Code Base Creation | Areeb Ijaz | | Update Gatsby Framework | Areeb Ijaz
|
...
- Look into the Hosting options. Main aspects to consider are &#39;Will git pages work long term OR
  is Google Cloud Platform (GCP) too costly to maintain? Liaise with Deployment team as they should
...
rights regarding the data collected. It is the team&#39;s intention to respect their users&#39;
privacy and ensure the protection of their data through the development of risk mitigation
...
- Develop procedure to communicatedata breaches and cyber attacks
...
to understand the expectations of companies and how they approach risks,
handlingusers&#39;personaldata,cookiesand howtocommunicatewith a user.
...
to coordinate the group, a full group meeting has not occurred and will be conducted on Tuesday 26th
April – with the Area Leads overseeing.

##### Forecast

It is likely that some progress will be made toward the short-term deliverables by the end of
trimester. The team will be reaching out to learn more about the data collected by each product.
Refer to product Forecast.
...
None of the long-term deliverables were considered this trimester due to the delayed start.
...
| Risk and Compliance Report: SplashKit | Charanjeet Singh | | Privacy Policy: SplashKit |
Charanjeet Singh | | Risk and Compliance report: DreamBig | Shiv Bhanu | | Privacy Policy: DreamBig
| Shiv Bhanu |
...
All these show case videos can be found in Thoth Tech General Files  Company OnTrack Tasks 
Showcase Videos.
...
![Shape2](RackMultipart20220529-1-v9ey3u_html_ed41e682ac5a1dde.gif)
